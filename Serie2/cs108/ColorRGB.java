...
public final class ColorRGB {
     ...
     */
    public ColorRGB mixWith(ColorRGB that, float p) {
        if (! (0.0 <= p && p <= 1.0))
    ...
    /**
     * Convertit la couleur en une couleur JavaFX.
     * @return La couleur JavaFX correspondant à la couleur réceptrice.
     */
    public Color toJavaFXColor() {
        return new Color(gammaEncode(r), gammaEncode(g), gammaEncode(b), 1d);
    }
